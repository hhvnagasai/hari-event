          ...
          <form onSubmit={handleValidateTicket} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent uppercase text-sm"
                  disabled={loading}
                />
                <FaQrcode className="absolute right-3 top-3.5 text-gray-400 pointer-events-none" style={{ fontSize: 16 }} />
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm whitespace-nowrap"
              >
                {loading ? (
                  <>
